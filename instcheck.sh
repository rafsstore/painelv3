...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/checkuser.py > /dev/null 2>&1
