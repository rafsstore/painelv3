...
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/gestorssh18.zip > /dev/null 2>&1
...
function inst_db { 
cd || exit
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
echo ""
echo -e "                 \033[1;31mBy @Rafael_Djaay\033[1;36m"
echo ""
...
tst_bkp
clear
echo -e "\033[1;32m RAFS PWEB V3 INSTALADO COM SUCESSO!"
echo ""
echo -e "                 \033[1;31mBy @Rafael_Djaay\033[1;36m"
echo ""
