...
IP=$(wget -qO- ipv4.icanhazip.com)
clear
echo -e "\E[44;1;37m    ATUALIZANDO O PAINEL RAFS PWEB V3     \E[0m"
echo ""
echo -e "                              \033[1;31mBy @Rafael_Djaay\033[1;36m"
echo -e "   RAFS PWEB V3" | figlet
echo ""
clear
#
...
rm -rf * > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/gestorssharm18.zip > /dev/null 2>&1
sleep 1
...
echo -e "   RAFS PWEB V3" | figlet
echo ""
echo -e "\033[1;36m PAINEL RAFS PWEB V3 DIGITE ESSE IP NO NAVEGADOR:\033[1;37m http://$IP/admin\033[0m"
echo ""
