#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR RAFS PWEB V3\033[0m"
...
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/sshplus.zip.001 > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/sshplus.zip.002 > /dev/null 2>&1
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/sincpainel.zip > /dev/null 2>&1
