...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "Instalador Painel RAFS PWEB V3 CENTOS 7" ; tput sgr0 ; echo ""
echo "Continuar? Y\n"
echo -n "> "
read option
if [ $option = "Y" ]; then
...
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://raw.githubusercontent.com/rafsstore/painelv3/main/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://raw.githubusercontent.com/rafsstore/painelv3/main/uteste > /bin/usersteste.sh
wget -qO- https://raw.githubusercontent.com/rafsstore/painelv3/main/backupauto > /bin/autobackup.sh
