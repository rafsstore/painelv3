...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "INSTALAR PAINEL RAFS PWEB V3 CENTOS 7" ; tput sgr0 ; echo ""
echo "Continuar? S\n"
echo -n "> "
read option
if [ $option = "S" ]; then
...
wget https://raw.githubusercontent.com/rafsstore/painelv3/raw/cent7/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/rafsstore/painelv3/raw/gestorssh.zip > /dev/null 2>&1
...
createdb(){
wget https://raw.githubusercontent.com/rafsstore/painelv3/raw/bdgestorssh.sql > /dev/null 2>&1
...
cd /bin || exit
wget https://raw.githubusercontent.com/rafsstore/painelv3/raw/userteste.sh
wget https://raw.githubusercontent.com/rafsstore/painelv3/raw/autobackup.sh
